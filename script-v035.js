/*
  ...
  Build: v0.3.5 - 2026-05-06 15:35 BRT
  Mobile-first landscape, GitHub Pages, assets externos via manifesto.
*/
const BUILD={version:'v0.3.5',datetime:'2026-05-06 15:35 BRT',label:'Build v0.3.5 - 2026-05-06 15:35 BRT'};
const SAVE_KEY='vale_chess_3d_career_save_v035';
const LEGACY_SAVE_KEYS=['vale_chess_3d_career_save_v034','vale_chess_3d_career_save_v033','vale_chess_3d_career_save_v032','vale_chess_3d_career_save_v031','vale_chess_3d_career_save_v030','vale_chess_3d_career_save_v029','vale_chess_3d_career_save_v028','vale_chess_3d_career_save_v027','vale_chess_3d_career_save_v026','vale_chess_3d_career_save_v025','vale_chess_3d_career_save_v024','vale_chess_3d_career_save_v023','vale_chess_3d_career_save_v022','vale_chess_3d_career_save_v021','vale_chess_3d_career_save_v020'];
const ASSET={
...
function init(){ safeText('buildInfo',BUILD.label); hydrateProfile(); bind(); load(); startAiWatchdog(); const cb=$('continueBtn'); if(save){show('coverScreen'); if(cb) cb.disabled=false}else{if(cb) cb.disabled=true; show('coverScreen')} }
...
function showResult(won,reason){
  ...
  const summary=carAfter?` Rating atual: ${carAfter.rating}. Placar da carreira: ${carAfter.wins}V / ${carAfter.losses}D. Títulos: ${carAfter.titles.length}.`:'';
