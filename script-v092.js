...
const RELEASE_CANDIDATE_CHECKS=[
  ['Build visivel',()=>!!document.getElementById('buildInfo')&&document.getElementById('buildInfo').textContent.includes('v0.9.0')],
